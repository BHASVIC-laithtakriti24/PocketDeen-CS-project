...
async function fetchPrayerTimes() {
    try {
        const response = await fetch("https://api.aladhan.com/v1/timingsByCity/2026-02-21?city=Brighton%20and%20Hove&country=United%20Kingdom&method=2");// The prayer Api
